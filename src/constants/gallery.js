export const GALLERY_IMAGES = [
  ...
  { id: 2, src: 'https://images.unsplash.com/photo-1545249390-6bdfa286032f?w=400&q=80', name: 'Golden Pothos', scientific: 'Epipremnum aureum', price: '₱280', care: 'Easy', light: 'Low Light', category: 'indoor', petSafe: false },
  { id: 3, src: 'https://images.unsplash.com/photo-1509937528035-ad76254b0356?w=400&q=80', name: 'Peace Lily', scientific: 'Spathiphyllum wallisii', price: '₱550', care: 'Easy', light: 'Low Light', category: 'indoor', petSafe: false },
  { id: 4, src: 'https://images.unsplash.com/photo-1545249390-6bdfa286032f?w=400&q=80', name: 'Golden Pothos', scientific: 'Epipremnum aureum', price: '₱280', care: 'Easy', light: 'Low Light', category: 'indoor', petSafe: false },
  { id: 5, src: 'https://images.unsplash.com/photo-1490750967868-88aa4486c946?w=400&q=80', name: 'Chinese Evergreen', scientific: 'Aglaonema commutatum', price: '₱380', care: 'Easy', light: 'Low Light', category: 'indoor', petSafe: false },
  ...
  { id: 7, src: 'https://images.unsplash.com/photo-1459411552884-841db9b3cc2a?w=400&q=80', name: 'African Violet', scientific: 'Saintpaulia ionantha', price: '₱240', care: 'Moderate', light: 'Indirect Light', category: 'indoor', petSafe: true },
  { id: 8, src: 'https://images.unsplash.com/photo-1459156212016-c812468e2115?w=400&q=80', name: 'Hoya Carnosa', scientific: 'Hoya carnosa', price: '₱370', care: 'Easy', light: 'Bright Light', category: 'indoor', petSafe: true },

  // MARCOTTED TREES
  { id: 9, src: 'https://images.unsplash.com/photo-1518531933037-91b2f5f229cc?w=400&q=80', name: 'Marcotted Calamansi', scientific: 'Citrus microcarpa (marcot)', price: '₱450', care: 'Easy', light: 'Bright Light', category: 'marcotted', petSafe: true },
  ...
  { id: 11, src: 'https://images.unsplash.com/photo-1518531933037-91b2f5f229cc?w=400&q=80', name: 'Marcotted Lemon', scientific: 'Citrus limon (marcot)', price: '₱520', care: 'Easy', light: 'Bright Light', category: 'marcotted', petSafe: true },
  { id: 12, src: 'https://images.unsplash.com/photo-1485955900006-10f4d324d411?w=400&q=80', name: 'Marcotted Guyabano', scientific: 'Annona muricata (marcot)', price: '₱550', care: 'Easy', light: 'Bright Light', category: 'marcotted', petSafe: true },
  ...
  { id: 18, src: 'https://images.unsplash.com/photo-1523049673857-eb18f1d7b578?w=400&q=80', name: 'Grafted Avocado', scientific: 'Persea americana (grafted)', price: '₱950', care: 'Moderate', light: 'Bright Light', category: 'grafted', petSafe: false },
  { id: 19, src: 'https://images.unsplash.com/photo-1553279768-865429fa0078?w=400&q=80', name: 'Grafted Jackfruit', scientific: 'Artocarpus heterophyllus', price: '₱780', care: 'Easy', light: 'Bright Light', category: 'grafted', petSafe: true },
  { id: 20, src: 'https://images.unsplash.com/photo-1509587584298-0f3b3a3a1797?w=400&q=80', name: 'Grafted Duhat', scientific: 'Syzygium cumini (grafted)', price: '₱650', care: 'Easy', light: 'Bright Light', category: 'grafted', petSafe: true },
  ...
  // OUTDOOR & FRUIT
  { id: 33, src: 'https://images.unsplash.com/photo-1459411552884-841db9b3cc2a?w=400&q=80', name: 'Fruiting Calamansi', scientific: 'Citrus microcarpa', price: '₱350', care: 'Easy', light: 'Bright Light', category: 'outdoor', petSafe: true },
  { id: 34, src: 'https://images.unsplash.com/photo-1553279768-865429fa0078?w=400&q=80', name: 'Dwarf Coconut', scientific: 'Cocos nucifera (dwarf)', price: '₱1,200', care: 'Easy', light: 'Bright Light', category: 'outdoor', petSafe: true },
  ...
  { id: 36, src: 'https://images.unsplash.com/photo-1459156212016-c812468e2115?w=400&q=80', name: 'Bird of Paradise', scientific: 'Strelitzia reginae', price: '₱1,500', care: 'Moderate', light: 'Bright Light', category: 'outdoor', petSafe: false },
  { id: 37, src: 'https://images.unsplash.com/photo-1463320726281-696a485928c7?w=400&q=80', name: 'Papaya Tree', scientific: 'Carica papaya', price: '₱250', care: 'Easy', light: 'Bright Light', category: 'outdoor', petSafe: true },
  { id: 38, src: 'https://images.unsplash.com/photo-1545249390-6bdfa286032f?w=400&q=80', name: 'Banana Plant', scientific: 'Musa acuminata', price: '₱300', care: 'Easy', light: 'Bright Light', category: 'outdoor', petSafe: true },
  { id: 39, src: 'https://images.unsplash.com/photo-1509587584298-0f3b3a3a1797?w=400&q=80', name: 'Bougainvillea', scientific: 'Bougainvillea spectabilis', price: '₱380', care: 'Easy', light: 'Bright Light', category: 'outdoor', petSafe: true },
  ...
  // MORE OUTDOOR
  { id: 45, src: 'https://images.unsplash.com/photo-1523049673857-eb18f1d7b578?w=400&q=80', name: 'Sampaguita', scientific: 'Jasminum sambac', price: '₱200', care: 'Easy', light: 'Bright Light', category: 'outdoor', petSafe: true },
  { id: 46, src: 'https://images.unsplash.com/photo-1490750967868-88aa4486c946?w=400&q=80', name: 'Gumamela', scientific: 'Hibiscus rosa-sinensis', price: '₱150', care: 'Easy', light: 'Bright Light', category: 'outdoor', petSafe: true },
  { id: 47, src: 'https://images.unsplash.com/photo-1518531933037-91b2f5f229cc?w=400&q=80', name: 'Aratiles Tree', scientific: 'Muntingia calabura', price: '₱350', care: 'Easy', light: 'Bright Light', category: 'outdoor', petSafe: true },
  { id: 48, src: 'https://images.unsplash.com/photo-1553279768-865429fa0078?w=400&q=80', name: 'Bayabas', scientific: 'Psidium guajava', price: '₱280', care: 'Easy', light: 'Bright Light', category: 'outdoor', petSafe: true },
  { id: 49, src: 'https://images.unsplash.com/photo-1459156212016-c812468e2115?w=400&q=80', name: 'Siling Labuyo', scientific: 'Capsicum frutescens', price: '₱80', care: 'Easy', light: 'Bright Light', category: 'outdoor', petSafe: true },
  { id: 50, src: 'https://images.unsplash.com/photo-1485955900006-10f4d324d411?w=400&q=80', name: 'Malunggay', scientific: 'Moringa oleifera', price: '₱120', care: 'Easy', light: 'Bright Light', category: 'outdoor', petSafe: true },
];
